...
<section class="bg-white border-b">
    <div class="max-w-7xl mx-auto px-6 lg:px-8 py-16">
        ...
        <p class="mt-5 text-lg text-gray-500 max-w-2xl">
            Temukan berbagai kategori produk UMKM Indonesia. Pilih kategori yang Anda minati untuk melihat seluruh produk yang tersedia.
        </p>
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8">
            ...
            <a href="{{ route('produk') }}"
                ...
                <img src="{{ asset('images/kategori/kerajinan.jpg') }}"
                ...
                <div class="p-6">
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <span class="bg-[#3B5D50]/10 text-[#3B5D50] px-3 py-1 rounded-full text-sm">
                            480 Produk
                        </span>
                    ...
                    <p class="mt-3 text-gray-500">
                        Produk handmade, anyaman, ukiran kayu, souvenir, dan berbagai kerajinan khas daerah.
                    </p>

                    <button
                        class="mt-6 w-full bg-[#3B5D50] text-white py-3 rounded-xl hover:bg-[#2f4b40] transition">
            ...
            <a href="{{ route('produk') }}"
                ...
                <img src="{{ asset('images/kategori/fashion.jpg') }}"
                    class="w-full h-56 object-cover group-hover:scale-105 transition duration-500">
                ...
                <div class="p-6">
                    ...
                    <p class="mt-3 text-gray-500">
                        Batik, pakaian, tas, sepatu, aksesoris, dan produk fashion karya UMKM.
                    </p>
            ...
            <a href="{{ route('produk') }}"
                ...
                <img src="{{ asset('images/kategori/makanan.jpg') }}"
                    class="w-full h-56 object-cover group-hover:scale-105 transition duration-500">
                ...
                <div class="p-6">
                    ...
                    <p class="mt-3 text-gray-500">
                        Berbagai makanan khas, kopi, camilan, dan minuman lokal berkualitas.
                    </p>
            ...
            <a href="{{ route('produk') }}"
                ...
                <img src="{{ asset('images/kategori/dekorasi.jpg') }}"
                    class="w-full h-56 object-cover group-hover:scale-105 transition duration-500">
                ...
                <div class="p-6">
                    ...
                    <p class="mt-3 text-gray-500">
                        Dekorasi rumah, furnitur, tanaman hias, dan perlengkapan interior.
                    </p>
...
<section class="pb-20">
    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div class="bg-[#3B5D50] rounded-3xl text-white p-12 text-center">
            ...
            <p class="mt-4 text-green-100">
                Jelajahi seluruh produk UMKM Indonesia dan temukan produk terbaik dari berbagai daerah.
            </p>

            <a href="{{ route('produk') }}"
                class="inline-block mt-8 bg-white text-[#3B5D50] px-8 py-4 rounded-2xl font-semibold hover:bg-gray-100 transition">
                Lihat Semua Produk
            </a>
        </div>
    </div>
